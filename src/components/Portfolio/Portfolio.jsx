    ...
    >
      ...
      <div className={`innerWidth flexCenter ${css.container}`}>
        ...
        >
          <div>
            ...
            <p style={{ marginTop: "10px" }}>
              Perfect solution for Frontend Needs
            </p>
          </div>
        ...
        <div className={`flexCenter ${css.showCase}`}>
          <a href="https://digishops.vercel.app/" target="_blank">
            <motion.img
          ...
          <a
            href="https://movie-hub-abdulrehman421.vercel.app/"
            target="_blank"
          >
            <motion.img
          ...
          <a href="https://nike-concpt.vercel.app/" target="_blank">
            <motion.img
              variants={fadeIn("up", "tween", 0.7, 0.6)}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
          ...
          <a
            href="https://cryptoverse-react-abdul.netlify.app/"
            target="_blank"
          >
            <motion.img
              variants={fadeIn("up", "tween", 0.9, 0.6)}
          ...
          <a href="https://realtime-voice-text.vercel.app/" target="_blank">
            <motion.img
              variants={fadeIn("up", "tween", 0.7, 0.6)}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
